...
- `DEFAULT_PROJECT`: Default BigQuery project name (e.g., 'curated-dwh'). Overridden by `--default_project` argument.
- `SNAPSHOT_PROJECT`: Snapshot table project name (e.g., 'curated-dwh-snapshot'). Overridden by `--snapshot_project` argument.
